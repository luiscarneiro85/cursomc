...
public class DBService {
	...
	@Autowired
	private ProdutoRepository produtoReository;
	@Autowired
	...
	public void instantiateTestDataBase() throws ParseException {
		...
		produtoReository.saveAll(Arrays.asList(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11)); 
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "gamesovelhanegra@gmail.com", "36378912377", TipoCliente.PESSOAFISICA);
